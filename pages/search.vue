  ...
  mounted() {
    ...
    try {
      ...
      arrayPromises.push(new Promise((resolve, reject) => {
        axios.get(process.env.BACKEND_URL + '/api/publicaciones?populate=media')
          .then(response => {
      ...
      arrayPromises.push(new Promise((resolve, reject) => {
        axios.get(process.env.BACKEND_URL + '/api/publicaciones?populate=media&filters[titulo][$contains]=' + this.$route.params.searchTerms)
          .then(responseTitle => {
      ...
      arrayPromises.push(new Promise((resolve, reject) => {
        axios.get(process.env.BACKEND_URL + '/api/publicaciones?populate=media&filters[cuerpo][$contains]=' + this.$route.params.searchTerms)
          .then(responseBody => {
