  ...
  <div>
    ...
    :style="windowWidth < 770 ? 'margin-left: 5%; margin-right: 5%' : ''">
      <article class="tile is-child notification " style="background-color:  transparent;">
        <h1 class="title"> Todas las iniciativas </h1>
      </article>
    </div>
...
export default {
  ...
  async created() {
    try {
      ...
      await axios.get('https://pristine-biscayne-20430-612b2c9251a8.herokuapp.com/api/publicaciones?populate=media&filters')
        .then(response => {
