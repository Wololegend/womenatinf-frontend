    ...
    <div>
        ...
        <nav v-if="pages > 1" class="pagination" role="navigation" aria-label="pagination">
            <ul class="pagination-list is-flex is-justify-content-center">
                <li>
                    <nuxt-link v-if="$route.params.page > 1" :to="`/more/${$route.params.page - 1}`" class="pagination-previous"> < </nuxt-link>
                </li>
                <li v-for="(item, index) in paginatedPosts">
                    <nuxt-link v-if="(index + 1) == $route.params.page" :to="`/more/${index * 1 + 1}`"
                ...
                <li>
                    <nuxt-link v-if="$route.params.page < pages" :to="`/more/${$route.params.page * 1 + 1}`"
